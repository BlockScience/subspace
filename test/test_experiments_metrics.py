...
def test_profit1(sim_df_sanity_check):
    result = profit1(sim_df_sanity_check)
    return result


def test_average_profit1(sim_df_sanity_check):
    result = average_profit1(sim_df_sanity_check)
    return result
